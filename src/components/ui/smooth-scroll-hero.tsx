        ...
        >
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 leading-relaxed font-medium">
              Вступай в Run Club и начни бегать с теми, кто разделяет твой азарт.
              <br className="hidden md:block" />
              Первая пробежка — уже на этой неделе.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              <div className="text-center">
                ...
                <div className="text-2xl md:text-3xl font-black text-white mb-1">2 400+</div>
                <div className="text-xs md:text-sm text-gray-300 font-medium">Участников клуба</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Точек встреч</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Пробежки в неделю</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Финишей в 2024</div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-6 border-t border-white/20">
              <p className="text-xs text-gray-400 mb-3 font-medium">ПРИСОЕДИНЯЙСЯ — ЭТО БЕСПЛАТНО</p>
              <div className="flex flex-wrap justify-center items-center gap-4 text-gray-300">
                ...
                <span className="text-xs font-semibold">ПЕРВАЯ ПРОБЕЖКА БЕСПЛАТНО</span>
              </div>
            </div>
          </div>
        </motion.div>
